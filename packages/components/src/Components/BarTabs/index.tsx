...
import DragAndResize, { DragAndResizeRefType,DragAndResizeProp } from '../DragAndResize';
import Icon from '../Icon';
import { closeIcon } from '../../assets';
import BarButton, { BarButtonProps, BarButtonRefType } from '../BarButton';

interface BarTabsProp extends DragAndResizeProp,Omit<BarButtonProps, 'dragResizeRef'|'children'>{
}
