import {handleComponentInfo, handleRequiredHasChild} from "../utils";
import configs from '@/configs'
import get from "lodash/get";
import { merge } from "lodash";
import {StateType} from "@/store/interfaces";
import {selectComponentType} from "@/store";
...
export function selectComponent(state:StateType, payload:selectComponentType ) {
    ...
    let { propsConfig,nodePropsConfig } = get(configs.AllComponentConfigs, componentName);
