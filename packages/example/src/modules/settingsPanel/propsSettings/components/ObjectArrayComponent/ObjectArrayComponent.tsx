...
import {addPropsConfig} from "@/store";
...
function ObjectArrayComponent(props: ObjectArrayPropsType, ref: any) {
  ...
  const { value, childPropsConfig, type, fatherFieldLocation, field, onChange } = props;
  ...
  useEffect(() => {
    ...
    let timer = setTimeout(() => {
      addPropsConfig({
        ...
        fatherFieldLocation: formatPropsFieldConfigLocation(type, field, fatherFieldLocation),
      })
