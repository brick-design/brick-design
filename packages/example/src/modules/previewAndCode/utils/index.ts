...
// import {ComponentConfigsType, VirtualDOMType} from '@/store';
...
//  */
// function renderElementToJSX(childNodesArr: string[], indent = '', componentNames: Set<string> = new Set(), functionMap?: any, styleSheet?: any, isPropNode?: boolean) {
...
//   /** 属性值解析生成代码 */
//
//   each(childNodesArr, (key, index) => {
//     const { componentName, childNodes=null, props } = {componentName:'',props:{}};
...
//  */
//
// export function generatePageCode(childNodesArr: ComponentConfigsType) {
