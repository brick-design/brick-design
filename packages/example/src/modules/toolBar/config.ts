...
import {changeStyles, clearChildNodes, copyComponent, deleteComponent, PlatformStyleType, redo, undo} from 'brickd-core';
 ...
 */
 const configs:any= [{
  ...
  group: [
    ...
    { title: 'resetStyle', icon: 'form', type: changeStyles },
  ],
}, {
  span: 8,
  style: { justifyContent: 'flex-end' },
