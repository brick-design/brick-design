...
import { Icon } from '../designPanel/components';
...
function ToolBar() {
  const { selectedInfo, componentConfigs, undo, redo, styleSetting, platformInfo } = useSelector(['selectedInfo', 'componentConfigs', 'undo', 'redo', 'styleSetting', 'platformInfo']);
