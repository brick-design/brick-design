...
import {ChildNodesType, clearChildNodes, copyComponent, deleteComponent, useSelector, VirtualDOMType} from '@/store';
import domTreeIcons from './domTreeIcons';
import {
    controlUpdate, getDropTargetInfo,
    getDropTargetInfo as getDropTarget,
    handleSelectedStatus,
    HookState,
    onMouseOver,
    selectedStatus, SpecialPropsType
} from '@/modules/designPanel/commom/handleFuns';
import {stateSelector} from "@/modules/designPanel/commom/constants";
import {string} from "prop-types";
import {NodeProps, NodePropsConfigType} from "@/types/ComponentConfigType";
...
function SortItem(props: SortItemPropsType) {
    ...
    useEffect(()=>{
        return ()=>console.log('哈哈哈》》》》》卸载',componentName)
    ...
    const {fatherNodesRule,nodePropsConfig} = get(config.AllComponentConfigs, componentName);
    ...
    return (
        <div
            ...
            onDragEnter={(e: any) => {
                ...
                if (!childNodes) return getDropTarget(e)
                ...
                getDropTarget(e, key, propNameResult)
            }}
        >
