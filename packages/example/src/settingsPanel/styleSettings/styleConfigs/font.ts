...
const textTransform = ['none', 'capitalize', 'uppercase', 'lowercase', 'full-width'];
const textDecoration = ['none', 'underline', 'overline', 'line-through', 'blink'];
...
const fontStretch = ['ultra-condensed', 'extra-condensed', 'condensed', 'semi-condensed', 'normal', 'semi-expanded', 'expanded', 'extra-expanded', 'ultra-expanded'];
export default {
  fontFamily: {
    label: '字体',
    labelSpan: 0,
  ...
  color: {
    ...
    props: { isShowInput: false, isFont: true, isShowColor: true, colorColProps: { span: 24 } },
  },
  textIndent: {
    label: '文本缩进',
    labelPlace: 'bottom',
