...
import {
	CommonPropsType,
	controlUpdate, handlePropsClassName,
	HookState,
	propAreEqual,
	stateSelector,
...
function NoneContainer(allProps: CommonPropsType, ref: any) {
	...
	const {onClick,onDoubleClick,onMouseOver,onDragStart,setSelectedNode}=useEvents(parentRootNode,specialProps,isSelected);
