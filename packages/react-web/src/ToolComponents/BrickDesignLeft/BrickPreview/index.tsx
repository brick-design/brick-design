...
import SearchResult, { CategoryInfoType, CategoryType, renderDragItem, SearchRefType } from './SearchResult'
  ...
  return (
    <div className={styles['container']}>
      <SearchBar onChange={onChange}>
        <div style={{display:!isShowSearch?'flex':'none'}} className={styles['fold-container']}>
            <Collapse
              activeKey={openKeys}
        ...
        <SearchResult componentsCategory={componentsCategory}
                      ref={searchRef}
