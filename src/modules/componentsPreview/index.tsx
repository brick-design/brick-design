  ...
  return (
    <Tabs className={styles['tabs-container']} activeKey={activeKey}
      ...
      <TabPane forceRender className={styles['tabs-panel']}
               tab={formatMessage({ id: 'BLOCK_NAME.componentsPreview.container' })} key="container">
      ...
      <TabPane forceRender className={styles['tabs-panel']}
               tab={formatMessage({ id: 'BLOCK_NAME.componentsPreview.nonContainer' })} key="nonContainer">
      ...
      <TabPane className={styles['tabs-panel']} style={{ paddingLeft: 20, paddingRight: 20 }}
               tab={formatMessage({ id: 'BLOCK_NAME.componentsPreview.template' })} key="module">
