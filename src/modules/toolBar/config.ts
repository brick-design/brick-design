...
export default [{
  ...
  group: [
    ...
    { title: 'redo', icon: 'redo', event: 'redo' },
    // {title:'属性重做',icon:'shuxing',event:'resetProps'},
    { title: 'resetStyle', icon: 'form', event: 'resetStyle' },
  ],
}, {
  span: 8,
  style: { justifyContent: 'flex-end' },
  ...
  group: [
    { title: 'save', icon: 'save', event: 'saveComponentsInfo' },
    { title: 'copy', icon: 'copy', event: 'copyComponent' },
    { title: 'clear', icon: 'rest', event: 'clearChildNodes' },
    { title: 'delete', icon: 'delete', event: 'deleteComponent' },
...
export const ENABLED = {
  selected: ['copy', 'clear', 'delete', 'generateTemplate'],
  must: ['preview', 'save', '导出代码'],
};
